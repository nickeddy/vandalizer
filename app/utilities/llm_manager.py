...
class LLMManager:
    ...
    def ask_openai(self):
        llm = ChatOpenAI(openai_api_key="***REMOVED***")
    ...
    def ask_all_documents(self, space, question):
        llm = ChatOpenAI(model_name="gpt-3.5-turbo-16k", openai_api_key="***REMOVED***")
    ...
    def ask_single_document(self, question, document, model_name="text-davinci-003"):
        ...
        if model_name == "gpt-4" or model_name == "gpt-3.5-turbo-16k":
            llm = ChatOpenAI(model_name=model_name, openai_api_key="***REMOVED***")
        else:
            llm = OpenAI(model_name=model_name, openai_api_key="***REMOVED***")
    ...
    def ask_single_document_chained(self, question, document):
        ...
        loader.load()
        pages = loader.load()
        llm = OpenAI(model_name="text-davinci-003", openai_api_key="***REMOVED***")
